...
extends Node
## Родительский класс для всех кастомных классов, наследующих класс [Node].
## Предоставляет методы, необходимые для любого кастомного класса.
##
...
var _class_name : StringName = &"CustomNode": get = get_class_name
